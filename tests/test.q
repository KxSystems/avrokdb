...
runTests:{[options]
    ...
    sc:.avro.schemaFromFile["tests/single_simple.avsc"];
    input:`AA;
    serialised:.avro.encode[sc;input;options];
    output:.avro.decode[sc;serialised;options];
    show output;
    -1 "<----- Result ----->";
    show input~output;

    -1 "<----- Single array type ----->";
    sc:.avro.schemaFromFile["tests/single_array.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/simple.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/simple_array.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/nested_record_single.avsc"];
    nested:(``c`d)!(::;1.1;`AA);
    input:(``b)!(::;nested);
    serialised:.avro.encode[sc;input;options];
    output:.avro.decode[sc;serialised;options];
    ...
    sc:.avro.schemaFromFile["tests/nested_record.avsc"];
    nested:(``c`d)!(::;1.1;`AA);
    input:(``a`b)!(::;0b;nested);
    serialised:.avro.encode[sc;input;options];
    output:.avro.decode[sc;serialised;options];
    ...
    sc:.avro.schemaFromFile["tests/array_record_single.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/array_record.avsc"];
    nested:(``b`c)!(::;1b;0x0011);
    ...
    sc:.avro.schemaFromFile["tests/array_array_record_single.avsc"];
    nested:(``b`c)!(::;1b;0x0011);
    ...
    sc:.avro.schemaFromFile["tests/simple_array_array.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/array_array_record.avsc"];
    nested:(``b`c)!(::;1b;0x0011);
    ...
    sc:.avro.schemaFromFile["tests/simple_map.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/simple_array_map.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/simple_map_array.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/simple_map_map.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/logical_single.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/logical_array.avsc"];
    ...
    sc:.avro.schemaFromFile["tests/logical_maps.avsc"];
