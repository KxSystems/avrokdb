...
sc:.avrokdb.schemaFromFile["examples/scalars.avsc"];
input:(``a`b`c`d`e`f`g`h`i`j`k)!(::;0b;0x0011;1.1;`AA;0x00112233;2.2e;3i;4;::;"aa";(0h;"abc"));
-1 "<----- Input ----->";
show input;
-1 "<----- Binary Avro ----->";
binary_serialised:.avrokdb.encode[sc;input;(enlist `AVRO_FORMAT)!enlist `BINARY];
show binary_serialised;
-1 "<----- JSON Avro ----->";
json_serialised:.avrokdb.encode[sc;input;(enlist `AVRO_FORMAT)!enlist `JSON_PRETTY];
show json_serialised;
-1 "<----- Output ----->";
output:.avrokdb.decode[sc;binary_serialised;(enlist `AVRO_FORMAT)!enlist `BINARY];
show output;
-1 "<----- Result ----->";
show input~output;
...
-1 "\n<----- Record of logical types ----->\n";
sc:.avrokdb.schemaFromFile["examples/logical.avsc"];
